...
# Route to serve the blackout_dates data
get '/blackout_dates' do
    content_type :json
    courses = get_courses
    course_blackout_dates = courses.map do |course|
        blackout_date = get_blackout_date(course['id'])
        {
        name: course['name'],
        title: blackout_date['event_title'],
        start_date: blackout_date['start_date'],
        end_date: blackout_date['end_date']
        }
    end
    course_blackout_dates.to_json
end
